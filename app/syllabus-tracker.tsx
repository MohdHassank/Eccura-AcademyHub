    ...
    const fetchSyllabus = async () => {
        try {
            ...
            const response = await axios.get(
                `http://192.168.29.49:5000/api/student/syllabusTracker/${user.id}`
            );
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.accordionWrapper}>
                    {syllabusData.map((item) => {
                        ...
                        const subCompleted = item.completedTopics;
                        const subTotal = item.totalTopics;
                            ...
                            <View key={item.id} style={[styles.subjectCard, isExpanded && styles.activeSubjectCardBorder]}>
                                ...
                                {isExpanded && (
                                    <View style={styles.chaptersListBlock}>
                                        ...
                                        <Text style={styles.chapterNameText}>
                                            Remaining Topics: {item.totalTopics - item.completedTopics}
                                        </Text>
