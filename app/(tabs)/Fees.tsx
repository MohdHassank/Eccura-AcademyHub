      ...
      >
          ...
          <View style={styles.chartContainer}>
            <View style={styles.circularProgressTrack}>
              ...
              <View style={styles.circularInnerCircle}>
                ...
                <Text style={styles.chartPaidAmount}>₹ 18,500</Text>
        ...
        <View style={styles.breakdownCard}>
          ...
          <View style={styles.breakdownRow}>
            ...
            <Text style={[styles.breakdownValue, { fontWeight: '700' }]}>₹ 6,000</Text>
          </View>
          ...
          <View style={styles.actionMainContent}>
            ...
            <View style={styles.badgeInfoRow}>
              <View style={styles.badgeSubBlock}>
                ...
                <Text style={styles.badgeSubValueRed}>₹ 6,000</Text>
              </View>
              <View style={styles.badgeSubBlock}>
          ...
          <View style={styles.actionMainContent}>
            ...
            <View style={styles.badgeInfoRow}>
              <View style={styles.badgeSubBlock}>
                ...
                <Text style={styles.badgeSubValueBlue}>₹ 18,500</Text>
              </View>
              <View style={styles.badgeSubBlock}>
